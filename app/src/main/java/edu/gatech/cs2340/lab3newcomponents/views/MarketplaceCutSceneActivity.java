...
public class MarketplaceCutSceneActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uriPath = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.marketplacevid);
        ...
        simpleVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                Intent intent = new Intent(MarketplaceCutSceneActivity.this, MarketActivity.class);
