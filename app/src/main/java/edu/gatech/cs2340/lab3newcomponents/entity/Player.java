...
//    public static List<String> cargoList = new ArrayList<>();
     ...
     */
    public Player (String nam, Difficulty difficult, int fighter, int pilot, int trader, int engineer, int money, String cargoList,int fuel, String planet, String politics) {
        this.name = nam;
    ...
    public void setPlanet(String plan) { planet = plan; }
